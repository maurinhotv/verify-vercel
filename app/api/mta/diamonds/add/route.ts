...
export async function POST(req: Request) {
  try {
    ...
    const reason = typeof body.reason === "string" ? body.reason.slice(0, 80) : "mta_add";
    ...
    // Update com proteção simples (compare-and-swap)
    ...
    return NextResponse.json(
      { ok: true, account: user.username, newBalance: updated.diamonds, added: amount, reason },
